...
const EMAIL_STRINGS = {
  fr: {
    ...
    trial_body: "Votre essai gratuit de 14 jours se termine bientôt. Pour continuer à surveiller la réputation de {business} sans interruption, votre abonnement sera activé automatiquement.",
  ...
  en: {
    ...
    welcome_trial: '14-day free trial — no charge today',
    ...
    trial_body: 'Your 14-day free trial is ending soon. To continue monitoring the reputation of {business} without interruption, your subscription will be activated automatically.',
  ...
  es: {
    ...
    welcome_trial: 'Prueba gratuita de 14 días — sin cargo hoy',
    ...
    trial_body: 'Tu prueba gratuita de 14 días termina pronto. Para continuar monitoreando {business}, tu suscripción se activará automáticamente.',
  ...
  de: {
    ...
    welcome_trial: '14-tägige kostenlose Testversion — keine Belastung heute',
    ...
    trial_body: 'Ihre 14-tägige Testversion endet bald. Um {business} weiterhin zu überwachen, wird Ihr Abonnement automatisch aktiviert.',
  ...
  pt: {
    ...
    welcome_trial: 'Período de teste gratuito de 14 dias — sem cobrança hoje',
    ...
    trial_body: 'O seu período de teste gratuito de 14 dias termina em breve. Para continuar a monitorizar {business}, a sua subscrição será ativada automaticamente.',
  ...
  ar: {
    ...
    welcome_trial: 'تجربة مجانية لمدة 14 يومًا — لا رسوم اليوم',
    ...
    trial_body: 'تجربتك المجانية لمدة 14 يومًا تنتهي قريبًا. للاستمرار في مراقبة {business}، سيتم تفعيل اشتراكك تلقائيًا.',
